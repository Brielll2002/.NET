    ...
    public class FuncionarioService : IFuncionarioInterface
    {
        ...
        public async Task<ServiceResponse<List<FuncionarioModel>>> CreateFuncionarios(FuncionarioModel novoFuncionario)
        {
            ...
            try
            {
                ...
                serviceResponse.Mensagem = "Funcionário adicionado com sucesso !";
        ...
        public async Task<ServiceResponse<List<FuncionarioModel>>> InativaFuncionario(int id)
        {
            ...
            try
            {
                ...
                {
                    serviceResponse.Dados = null;
                    serviceResponse.Mensagem = "Usuário não licalizado!";
                    serviceResponse.Sucesso= false;
                }

                serviceResponse.Mensagem = "Funcionário desativado!";
